...
<body>
    ...
    //3. Pronađite indeks peak elementa u nizu. Peak element je element čija vrednost nije manja od oba suseda (ako postoji jedan, onda samo od tog jednog).
    ...
    function minAndMaxElement($arr)
    {
        ...
        return [min($arr), max($arr)]; //laksi nacin
    }
    ...
    {
        // foreach ($m as $matricared) {
        //     foreach ($matricared as $matrica1element) {
        //         print_r($matrica1element);
        //     }
        //     echo '<br>';
        // }
        $rows = count($m);
    ...
    //10. Napisati funkciju za izračunavanje sume elemenata na glavnoj dijagonali.
    ...
    {
        $indexEt = strpos($email, "@");
        return substr($email, 0, $indexEt);
    }
    ...
    //13. Napisati funkciju koja će ukloniti sve nule na početnu string-a i na kraju ako se nalaze posle zareza (tačke). Tako dobijen broj zokružiti na ceo broj i vratiti kao povratnu vrednost funkcije.
